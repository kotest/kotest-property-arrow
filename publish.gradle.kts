...
publishing {
  ...
  publications {
    register("mavenJava", MavenPublication::class) {
      ...
      pom {
        name.set("kotest-property-arrow")
        description.set("Kotest Property Testing for Arrow")
        url.set("http://www.github.com/kotest/kotest-property-arrow")

        scm {
          connection.set("scm:git:http://www.github.com/kotest/kotest-property-arrow")
